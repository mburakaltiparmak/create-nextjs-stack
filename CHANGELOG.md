...
- Replaced npm access-token authentication with OIDC trusted publishing for automated releases.
- Normalized the repository URL used by npm's trusted publisher verification.

## [0.3.2] - 2026-08-12

### Fixed

- Restored npm access-token authentication for automated releases after the previous token expired.
